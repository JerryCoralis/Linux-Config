-- xmonad config files, heavy borrowed from Brian Brightside & Jonah
-- edited by Jerry Li github: jerryCoralis
-- last updated Nov. 16 2017

-- main features: 4 tiling algorithms
-- file contains only SPC as whitespace
...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    , ((modm,           xK_w     ), swapNextScreen) -- multi monitor ws swap
    , ((modm,           xK_o     ), nextWS)
    , ((modm,           xK_i     ), prevWS)
    ...
    , ((modm .|. ctrlm, xK_l     ), spawn "xscreensaver-command -lock") -- Screensaver/lock screen
    ...
    , ((modm,           xK_F3 ), spawn "thunar")       -- Spawn a file manager
    ...
    -- mod-{w,e,r}, Switch to physical/Xinerama screens 1, 2, or 3 !!work
